...
const GalleryImageMapper: React.FC<GalleryImageMapperProps> = ({ title, description, date_upload, image_url, edit, deleteRow, data }) => {
    return (
        <div className="mb-5 flex items-center justify-center">
            <div className="max-w-[22rem] w-full bg-white shadow-[4px_6px_10px_-3px_#bfc9d4] rounded-xl border border-white-light dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none">
